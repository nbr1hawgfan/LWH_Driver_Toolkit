const CACHE_NAME='lwh-driver-toolkit-v1-10-0';
const ASSETS=['./','./index.html','./manifest.json','./css/app.css','./css/print.css','./js/storage.js','./js/qr.js','./js/barcode.js','./js/ui.js','./js/labels.js','./js/distance.js','./js/trailerinspect.js','./js/timesheet.js','./js/spottertimesheets.js','./js/scanner.js','./js/doc-auto-detect.js','./js/hos.js','./js/fuelcost.js','./js/loadsecure.js','./js/radar.js','./js/paperlog.js','./js/detention.js','./js/dvir.js','./js/utilities.js','./js/app.js','./icons/icon-192.png','./icons/icon-512.png','./icons/favicon.png','./icons/company-logo.png','./icons/shortcut-lookup.png','./icons/shortcut-picklist.png','./icons/shortcut-tools.png','./icons/shortcut-bol.png'];
